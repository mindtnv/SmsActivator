...
public class SmsHubServiceNameResolver : IServiceNameResolver
{
    ...
    public string ResolveServiceName(string service) => _services.ContainsKey(service) ? _services[service] : service;
}